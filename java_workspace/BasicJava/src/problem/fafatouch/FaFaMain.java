...
import java.util.Scanner;//클래스가 위치한 곳

public class FaFaMain {

	public static void main(String[] args) {
		
		Scanner sc = new Scanner(System.in); // sc노란밑줄은 도서관에서 빌려왔으니 반납을 하라는 경고
...
//		
		...
		//	System.out.println("▒ 음료사이즈업 하시겠습니까? (y/n)");
			...
			if(order.equals ("y")) {
				...
				if(totPrice > money) {
					...
					System.out.println("결제완료 고객님 맛있게드세요");
					
					break;//지불금액 > 결제금액(거스름돈주고)
							//지불금액 == 결제금액
				}
			}	
